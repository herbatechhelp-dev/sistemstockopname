    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="hidden lg:flex lg:flex-col w-64 bg-white border-r border-gray-200 shadow-sm">
            <div class="p-5 border-b border-gray-200">
                <h1 class="text-xl font-bold text-blue-700">SISO</h1>
                <p class="text-xs text-gray-500 mt-1">Stock Opname System</p>
            </div>
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                @if(in_array(auth()->user()->role, ['superadmin', 'admin']))
                    ...
                    <x-nav-link href="/admin/monitoring" :active="request()->is('admin/monitoring*')">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        Monitoring
                    </x-nav-link>
                @endif
