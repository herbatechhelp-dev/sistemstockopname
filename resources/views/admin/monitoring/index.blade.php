<x-layouts.app title="Monitoring Tim" header="Monitoring Progress SO">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between gap-3 mb-3">
            ...
            <form method="GET" class="flex-1 md:flex-none md:min-w-[280px]">
                <select name="session_id" onchange="this.form.submit()" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
